...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server" >
    ...
    <div style="text-align: left; margin-left: 20px;">
        ...
        <table class="style1">
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvFName" runat="server" ErrorMessage="First name is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtFName" 
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvLName" runat="server" ErrorMessage="Last name is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtLName" 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ErrorMessage="Email Address is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtEmail" 
                ...
                <td>
                    <asp:TextBox ID="txtEmailC" runat="server" TabIndex="4"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvEmailC" runat="server" ErrorMessage="Must Confirm Email Address"
                        ControlToValidate="txtEmailC" Display="Dynamic" 
                        ValidationGroup="vGroupBasicInfo" ForeColor="Red">*</asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="cvEmailC" runat="server" ErrorMessage="Email Addresses must be same"
                        ...
                        Display="Dynamic" ValidationGroup="vGroupBasicInfo" ForeColor="Red">*</asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtPhoneNo" runat="server" TabIndex="5"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvPhoneNo" runat="server" ErrorMessage="Phone Number is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtPhoneNo" 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                    ...
                    <asp:RegularExpressionValidator ID="revPhoneNo" runat="server" 
                        ...
                        ValidationExpression="0\d{1,3}-\d{5,7}" ForeColor="Red">*
                ...
                <td>
                    <asp:RadioButtonList ID="rdoListGender" runat="server" 
            ...
            <tr>
                ...
                <td width="275px">
                    <asp:TextBox ID="txtAddress" TextMode="MultiLine" Rows="3" runat="server" 
                        TabIndex="7"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Address field is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtAddress" 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
                </td>
                <td>
                    Date:</td>
            ...
            <tr>
                ...
                <td width="275">
                    ...
                    <asp:RequiredFieldValidator ID="rfvCardType" runat="server" 
                        ...
                        InitialValue="CARD TYPE" ValidationGroup="vGroupBasicInfo" ForeColor="Red">*</asp:RequiredFieldValidator>
                </td>
                <td>
                    <asp:Label ID="lblCVV" runat="server" Text="CVV: " Width="50px"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCVV" runat="server" TabIndex="10"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvCVV" runat="server" ErrorMessage="CVV field is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtCVV" 
                        Display="Dynamic" ForeColor="Red">*</asp:RequiredFieldValidator>
                    ...
                    <asp:RangeValidator ID="rvCVV" runat="server" ErrorMessage="CVV value out of range"
                       ValidationGroup="vGroupBasicInfo" ControlToValidate="txtCVV" MinimumValue="100"
                        MaximumValue="9999" Type="Integer" ForeColor="Red">*</asp:RangeValidator>
                </td>
            </tr>
            <tr>
                <td class="style2">
                ...
                <td class="style2">
                    ...
                    <asp:RequiredFieldValidator ID="rfvCardNo" runat="server" ErrorMessage="Card Number is required"
                        ValidationGroup="vGroupBasicInfo" ControlToValidate="txtCardNo" 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
    ...
    <p>
        <asp:CustomValidator ID="csvTermsBox" runat="server" ErrorMessage="Box must be checked"
            ...
            ValidationGroup="vGroupBasicInfo" ForeColor="Red">*</asp:CustomValidator>
        <asp:CheckBox ID="chkBxTerms" runat="server" 
            Text="By checking this check box you are agreeing to the TVI Cinema's terms and conditions" 
            TabIndex="12" />
        &nbsp;&nbsp;&nbsp;
    </p>
    <p>
