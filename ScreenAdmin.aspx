...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <p>
        ...
        <asp:SqlDataSource ID="dsScreen" runat="server" ConflictDetection="CompareAllValues"
            ...
            OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Showtimes]"
                ...
                <asp:ListView ID="lvwScreen" runat="server" DataKeyNames="Screen,Showtime" DataSourceID="dsScreen"
                    ...
                    <InsertItemTemplate>
                        <tr style="">
                            ...
                            <td>
                                <asp:TextBox ID="dimensionTextBox0" runat="server" Text='<%# Bind("dimension") %>' />
                            </td>
                        </tr>
                    </InsertItemTemplate>
                    <ItemTemplate>
                        <tr style="background-color: #DCDCDC; color: #000000;">
                            ...
                            <td>
                                <asp:Label ID="dimensionLabel0" runat="server" Text='<%# Eval("dimension") %>' />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
